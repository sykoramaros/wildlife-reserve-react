...
import { getObservationsByAnimalTaxonName } from "../../Services/WildlifeReserveService/WildlifeReserveService"
...
const AnimalsTry = () => {
  ...
  const handleSearch = () => {
    ...
    setError(null)
    getObservationsByAnimalTaxonName(inputValue)
      .then((data) => {
  ...
  return (
    <div>
      <h1 className="text-center text-success display-4 mt-4">Animals🐿️</h1>
