...
import { getObservationsByFungiTaxonName } from "../../Services/WildlifeReserveService/WildlifeReserveService"
...
const FungiTry = () => {
  ...
  const handleSearch = () => {
    ...
    setError(null)
    getObservationsByFungiTaxonName(inputValue)
      .then((data) => {
